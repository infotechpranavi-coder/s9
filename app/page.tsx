...
import { ChevronRight, MapPin, Mail, Phone, ArrowRight } from 'lucide-react';
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <Link href="/contact">
                ...
                whileHover={{ y: -2, scale: 1.02 }}
                whileTap={{ scale: 0.97 }}
                  className="inline-flex items-center justify-center rounded-full border border-[#148D8D]/40 bg-white px-8 py-3 text-sm font-semibold text-[#148D8D] hover:bg-[#148D8D]/10 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]"
              >
                Start Your Project
                </motion.span>
              </Link>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-[1.15fr,1fr] gap-10 lg:gap-14 items-center">
            <div className="relative">
              ...
              <div className="relative rounded-3xl bg-white shadow-[0_18px_45px_rgba(14,44,64,0.12)] border border-[#0E2C40]/5 px-8 py-8 md:px-10 md:py-10">
                ...
                <p className="text-base md:text-lg text-[#1A4A5A] leading-relaxed mb-6">
                  ...
                  residential projects—delivering value‑added design and execution with experienced
                ...
                <div className="flex flex-wrap gap-6 text-sm text-[#1A4A5A] mb-6">
                  ...
                  <div>
                    <p className="font-semibold text-[#0E2C40]">End‑to‑end</p>
            ...
            >
              <div className="absolute inset-0 rounded-3xl overflow-hidden shadow-[0_18px_45px_rgba(14,44,64,0.18)] border border-white">
                <img
                  src="https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=1200&q=80"
                  alt="Corporate office interior by S9 Enterprises"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="hidden sm:block absolute -bottom-6 -left-6 w-40 rounded-2xl bg-white/90 backdrop-blur border border-[#0E2C40]/10 px-4 py-3 shadow-lg shadow-[#0E2C40]/15">
                <p className="text-[11px] font-semibold text-[#148D8D] uppercase tracking-[0.16em] mb-1">
                  Recent project
                </p>
                <p className="text-xs text-[#0E2C40]">Corporate office interior – meeting & collaboration zone, Thane</p>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="rounded-2xl border border-[#0E2C40]/10 bg-[#f8faf9] p-4 sm:p-6 lg:p-8">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
              {CLIENTS.map((client, i) => (
                <div
                  key={i}
                  className="group relative overflow-hidden rounded-xl bg-white px-5 py-4 shadow-sm ring-1 ring-[#0E2C40]/10 hover:shadow-md hover:ring-[#148D8D]/30 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]"
                >
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-10">
            {TESTIMONIALS.map((testimonial, i) => (
              <motion.div
                ...
                style={{ animation: i === 0 ? 'testimonial-float 4s cubic-bezier(0.45,0,0.55,1) infinite' : 'testimonial-float-alt 4s cubic-bezier(0.45,0,0.55,1) infinite' }}
                className="relative overflow-hidden rounded-2xl bg-white border border-[#0E2C40]/10 px-8 py-8 shadow-[0_20px_50px_-12px_rgba(14,44,64,0.12)] hover:shadow-[0_24px_56px_-12px_rgba(14,44,64,0.18)] hover:border-[#148D8D]/20 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]"
              >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Link href="/projects">
                  <motion.span
                    ...
                    whileTap={{ scale: 0.98 }}
                    transition={{ duration: 0.25, ease: [0.32, 0.72, 0, 1] }}
                    className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#148D8D]/50 bg-transparent px-8 py-3.5 text-sm font-semibold text-[#148D8D] hover:bg-[#148D8D]/10 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]"
                  >
              View Portfolio
                  </motion.span>
                </Link>
